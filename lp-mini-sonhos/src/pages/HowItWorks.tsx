      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 mb-16">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="flex items-start gap-6 bg-white rounded-3xl p-8 shadow-sm border border-pink-100"
            >
        ...
        >
          <Link to={createPageUrl('Order')}>
            <Button 
              size="lg"
              className="bg-gradient-to-r from-pink-400 to-purple-400 hover:from-pink-500 hover:to-purple-500 text-white px-12 py-6 text-lg rounded-full shadow-lg"
            >
