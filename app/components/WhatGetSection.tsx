...
export default function WhatGetSection() {
    return (
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-t from-white to-pink-50">
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                    ...
                    <p className="text-purple-600 mb-8 sm:mb-10">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {['🧸 Squishy', '🖌️ Kit de pincéis', '✏️ Estojo', '📿 Pulseira', '🔑 Chaveiro', '📝 Post-it', '🖊️ Caneta', '🖍️ Marca-texto'].map((item, i) => (
                        <motion.span
                            ...
                            className="bg-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-purple-700 text-sm sm:text-base font-medium shadow-sm border border-pink-200"
                        >
                            {item}
                        </motion.span>
                    ))}
